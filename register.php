        ...
        <span class="icon-bar"></span>                       
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li><a href="lg.php"><span class="glyphicon glyphicon-user"></span> Your Account</a></li>
...
<a href="lg.php"><button type="button" class="Regbtn" style=" color: white;">Login</button></a>
</div>
</form>
</div>
    </div>
