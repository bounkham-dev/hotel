...
<body>
    ...
    <nav class="navbar navbar-inverse">
        ...
        <span class="icon-bar"></span>                        
                ...
                <a class="navbar-brand" href="#">LDC</a>
            </div>
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                    <img src="https://placehold.it/1500x500?text=Another Image Maybe" alt="Image">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid3">
                        <div class="product-image3">
                            <a href="#">
                                <img class="pic-1" src="image/1.png">
                                <img class="pic-2" src="image/1.png">
                            </a>
                            <ul class="social">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid3">
                        <div class="product-image3">
                            <a href="#">
                                <img class="pic-1" src="image/2.png">
                                <img class="pic-2" src="image/2.png">
                            </a>
                            <ul class="social">
                                <li><a href="#"><i class="fa fa-shopping-bag"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid3">
                        <div class="product-image3">
                            <a href="#">
                                <img class="pic-1" src="image/3.png">
                                <img class="pic-2" src="image/3.png">
                            </a>
                            <ul class="social">
                                <li><a href="#"><i class="fa fa-shopping-bag"></i></a></li>
                                <li><a href="#"><i class="fa fa-shopping-cart"></i></a></li>
...
<div class="container">
    ...
    <div class="jumbotron">
        <div class="container text-center">
            <div class="col-lg-12">
                <h1>About Us</h1>
                <p>khor moun khao2 khong bolisutva man bo li sutjut jum naiy y mi karn se khaiy neo dh pharn thang dh dae mi karn hai bo li karn neo dh dae mi khr d neo dh dae rthi baiy hai la ied</p>
                <hr>
